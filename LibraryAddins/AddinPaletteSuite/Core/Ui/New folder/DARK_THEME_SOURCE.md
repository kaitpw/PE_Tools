Below is the source codefor the Theme/Dark.xaml internal to wpf. it is toggled
by the ApplicationThemeManager
...
public class ThemesDictionary : ResourceDictionary
{
    ...
    private void SetSourceBasedOnSelectedTheme(ApplicationTheme? selectedApplicationTheme)
    {
        ...
        // (constant) string ApplicationThemeManager.ThemesDictionaryPath = "pack://application:,,,/Wpf.Ui;component/Resources/Theme/"
...
<ResourceDictionary xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation" xmlns:x="http://schemas.microsoft.com/winfx/2006/xaml">
    ...
    <Color x:Key="TextFillColorPrimary">#B31E1E1E</Color>
    <Color x:Key="TextFillColorSecondary">#B31E1E1E</Color>
    <Color x:Key="TextFillColorTertiary">#B31E1E1E</Color>
    <Color x:Key="TextFillColorDisabled">#B31E1E1E</Color>
    <Color x:Key="TextPlaceholderColor">#B31E1E1E</Color>
...
... Hundreds more lines assignings tatic resourcesto the brushes
```
