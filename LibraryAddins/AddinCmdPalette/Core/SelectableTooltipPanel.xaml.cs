...
public class SelectableTooltipPanel : UserControl
{
    ...
    private void InitializeControls()
    {
        ...
        {
            Background = (System.Windows.Media.Brush)this.TryFindResource("BackgroundFillColorTertiaryBrush") ?? System.Windows.Media.Brushes.Gray,
            BorderBrush = (System.Windows.Media.Brush)this.TryFindResource("ControlStrokeColorDefaultBrush") ?? System.Windows.Media.Brushes.DarkGray,
    ...
    {
        if (d is SelectableTooltipPanel panel)
        {
