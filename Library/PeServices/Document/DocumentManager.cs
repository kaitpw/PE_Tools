...
public class DocumentManager {
    ...
    public static IEnumerable<Document> GetOpenDocuments(UIApplication uiApp) =>
    ...
    public static bool IsDocumentOpen(UIApplication uiApp, Document doc) =>
        GetOpenDocuments(uiApp).Any(d => d.Title == doc.Title);

    /// <summary>Checks if a document is the active document. </summary>
    public static bool IsDocumentActive(UIApplication uiApp, Document doc) =>
    ...
    public static Document FindDocumentByName(UIApplication uiApp, string name) =>
    ...
    /// </summary>
    public static Document FindOpenFamilyDocument(UIApplication uiApp, Family family) =>
    ...
    public static ModelPath GetDocumentModelPath(Document doc) =>
        doc switch {
    ...
    public static string LogDocumentDetails(Document doc, string context = null) {
        var sb = new StringBuilder();
        if (!string.IsNullOrEmpty(context)) _ = sb.AppendLine($"=== {context} ===");
