...
public static class Automations
{
    ...
    public static AutomationElement FindElement(string automationId = null, string name = null, string localizedControlType = null, AutomationElement parent = null)
    {
        var root = parent ?? AutomationElement.RootElement;
        var scope = parent == null ? TreeScope.Descendants : TreeScope.Children;
        ...
        {
            var controlTypeCondition = new PropertyCondition(AutomationElement.LocalizedControlTypeProperty, localizedControlType);
    ...
    public static async Task<bool> ClickButtonAsync(string buttonName, string automationId = null, AutomationElement parent = null) => await Task.Run(() =>
    {
    ...
    {
        var element = FindElement(automationId: automationId, localizedControlType: "list item");
        if (element == null)
        {
